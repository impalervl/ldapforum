            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@contoso'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '192.168.0.2')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=contoso,dc=com'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'admin'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', '12QWasZXCVB'),
